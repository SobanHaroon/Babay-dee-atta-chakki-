  ...
  return (
    ...
    >
      ...
      <div
        ...
        onClick={onClick}
        className={cn(
          "card group flex flex-col justify-between bg-white border rounded-2xl p-3 sm:p-4 w-full max-w-full cursor-pointer h-full transition-all duration-300 overflow-hidden",
          isHovered
            ? "border-amber-400 shadow-xl ring-2 ring-amber-500/10 bg-amber-50/5"
