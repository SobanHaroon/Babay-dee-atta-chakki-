...
const TRENDING_KEYWORDS = ["Atta", "CHAWAL", "MIRCH", "RICE", "DAAL", "Desi Ghee", "Besan", "Chana Dal", "Shakkar"];
...
export function SearchBar({
  ...
  sortOption,
  onSortChange,
  placeholder = "Inquire products (e.g. Chakki Atta, Basmati 430, Desi Ghee)...",
