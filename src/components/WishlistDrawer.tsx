              ...
              {wishlistProducts.length === 0 ? (
                ...
                wishlistProducts.map((p) => (
                  <div
                    ...
                    className="flex gap-3 p-3 bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-slate-200/80 dark:border-slate-700/80 hover:border-slate-300 transition-all shadow-2xs group cursor-pointer"
                  >
                    <div
                      className="shrink-0"
                    >
                    ...
                    <div className="flex-1 min-w-0 flex flex-col justify-between">
                      <div>
                        <div className="flex justify-between items-start">
                          <h4
                            className="text-xs font-black text-slate-900 dark:text-slate-100 hover:text-[#3b4414] dark:hover:text-amber-400 line-clamp-1"
                          >
                            {p.name}
                          </h4>
                          <button
                      ...
                      <div className="flex items-center gap-2 mt-2 pt-2 border-t border-slate-200/60 dark:border-slate-700/60">
                        <button
                          ...
                          className="add-to-basket-btn flex-1 bg-[#3b4414] hover:bg-[#2c330e] text-white font-bold text-xs py-2 px-3 rounded-lg shadow-xs transition-all active:scale-95 uppercase tracking-wider"
                        >
                          <ShoppingBag className="w-4 h-4 shrink-0 text-amber-400" />
                          <span className="btn-text-label font-bold">ADD TO BASKET</span>
                        </button>
                      </div>
                    </div>
                  </div>
